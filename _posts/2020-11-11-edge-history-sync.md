...
As an Office 365 user and system admin the new Edge browser is clearly the way to finally get to a single managed browser across all of my organisations devices and to be honest I can't see any good reason for mamy organisations to like mine to still be using Chrome/Firefox other than industry inertia. So I rolled out Edge to my users many months ago now and am happy to report no real issues at all but I have still been a little frustrated at the slow pace around the completion of the sync options. 
