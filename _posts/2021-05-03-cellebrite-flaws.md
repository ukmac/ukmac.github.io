...
What is amazing to me is that a company whose entire existence depends on finding and using flaws in other companies software have engineered their own product so poorly. It will be interesting to see how this story develops, in particular will Apple take up the issue of their code being used in Cellebrite product ? Also, what will the files that Signal will be placing in in-app storage do (doesn't take too much imagination to guess there!) ?
